...
export POSTGRES_TO_REDSHIFT_S3_DATABASE_EXPORT_BUCKET=$(aws cloudformation describe-stack-resources --profile p2r --stack-name p2r --logical-resource-id s3Bucket | jq -r ".StackResources[0].PhysicalResourceId")
...
echo "POSTGRES_TO_REDSHIFT_S3_DATABASE_EXPORT_BUCKET=${P2R_S3_BUCKET}"
